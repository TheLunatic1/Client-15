...
export const FindProHero = () => {
  return (
    // Reduced bottom padding so the search bar straddles the boundary
    <section className="relative overflow-hidden bg-[#050f26] pt-[180px] pb-[60px]">
      ...
      <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle,_rgba(228,234,241,0.08)_1px,_transparent_1px)] bg-[length:32px_32px]" />
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-left">
        ...
        <motion.p
          ...
          className="text-white/50 text-lg max-w-2xl leading-relaxed font-medium mb-16"
        >
