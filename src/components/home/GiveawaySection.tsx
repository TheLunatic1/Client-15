...
const GiveawaySection = () => {
  const { config, showBanner } = useGiveaway();
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-6">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-white leading-tight">
                {c.bannerHeadline}{" "}
                <span className="text-[#097DDD]">{c.bannerHeadlineHighlight}</span>{" "}
                {c.bannerHeadlineSuffix}
              </h2>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-[11px] font-black uppercase tracking-[0.2em] text-white/50">
                  {c.bannerRegionsHeading}
                </p>
              </div>
              <div className="grid sm:grid-cols-2 gap-3">
                {c.regions.map((region, idx) => (
                  <motion.div
                    key={region.name}
              ...
              <p className="text-[11px] text-white/35 font-medium pt-1">{c.bannerFooterNote}</p>
            </div>
          </div>
        </motion.div>
      </div>
